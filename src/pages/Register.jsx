...
const Register = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (
      AllUser.find(
        (item) =>
          item.id != registerData.id && item.username != registerData.username
      )
    ) {
    ...
    <>
      <Row xs={1} md={2} className="mt-5">
            ...
            <div id="login">
              <div>
                <div className="d-flex justify-content-center align-items-center">
                  <img
                    src="https://najas06.github.io/RARE-KICKS/logo.png"
                    alt=""
                    width={150}
                    height={150}
                  />
        ...
        <Col style={{ height: "100vh" }}>
          <div className="d-flex justify-content-center align-items-center">
            <img
              src="https://najas06.github.io/RARE-KICKS/shoe2.png"
              alt=""
              style={{
                width: "100%",
                height: "100vh",
